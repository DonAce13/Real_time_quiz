...
!
function(t, e) {
  "object" == typeof exports && "undefined" != typeof module ? e(exports, require("angular")) : "function" == typeof define && define.amd ? define(["exports", "angular"], e) : e(t["@uirouter/angularjs"] = t["@uirouter/angularjs"] || {},
  t.angular)
} (this,
function(t, e) {
  "use strict";
  ...
  function n() {
    ...
    return function() {
      for (var r = e,
      n = t[e].apply(this, arguments); r--;) n = t[r].call(this, n);
      return n
    }
  }
  function i() {
  ...
  function N(t, e) {
    ...
    var a = this; ["encode", "decode", "equals", "$normalize"].forEach(function(e) {
      var r = t[e].bind(t),
      n = "equals" === e ? o: i;
      a[e] = n(r)
    }),
  ...
  function tt(t) {
    return t.parent && t.parent.data && (t.data = t.self.data = ye(t.parent.data, t.data)),
    t.data
  }
  function et(t) {
  ...
  function ft(t) {
    ...
    if (e) {
      ...
      return "SameAsCurrent" === e && r && r.abort(),
      Ue.ignored().toPromise()
    }
  }
  function lt(t) {
  ...
  function vt() {
    var t = null;
    return function(e, r) {
      return t = t || se.$injector.get("$templateFactory"),
      [new ti(e, r, t)]
    }
  }
  function mt(t) {
    ...
    function(e, r) {
      ...
      e), Zn(n, e) && Zn(i, e)) throw new Error("Cannot combine: " + n.join("|") + " with: " + i.join("|") + " in stateview: '" + r + "@" + t.name + "'");
  ...
  function gt(t) {
    function e(t, e, n, i, o, a) {
      return r._runtimeServices(i, t, n, e),
      delete hi.router,
      delete hi.$get,
      hi
    }
    hi = this.router = new Jr,
    hi.stateProvider = new ii(hi.stateRegistry, hi.stateService),
    hi.stateRegistry.decorator("views", mt),
    hi.stateRegistry.decorator("onExit", oi("onExit")),
    hi.stateRegistry.decorator("onRetain", oi("onRetain")),
    hi.stateRegistry.decorator("onEnter", oi("onEnter")),
    hi.viewService._pluginapi._viewConfigFactory("ng1", vt());
    var r = hi.locationService = hi.locationConfig = new ai(t);
    return ai.monkeyPatchPathParameterType(hi),
    hi.router = hi,
    hi.$get = e,
    ...
    return {
      ...
      compile: function(i) {
        ...
        function(i, c) {
          ...
          c.html(l.getTemplate(c, p) || a),
          ze.traceUIViewFill(f.$uiView, c.html());
          var h = t(c.contents()),
          d = l.controller,
          v = u(l),
          m = s(l),
  ...
  function xt(t, e, r, n, i) { ! Zt(r.$onInit) || i.viewDecl.component && Si || r.$onInit();
  ...
  Gt = function() {
    ...
    t.prototype.parameter = function(t, e) {
      return void 0 === e && (e = {}),
      this.url && this.url.parameter(t, e) || S(Re(this.params), Ht("id", t)) || e.inherit && this.parent && this.parent.parameter(t)
    },
  ...
  Ue = function() {
    ...
    e.superseded = function(r, n) {
      ...
      return n && n.redirected && (i.redirected = !0),
      i
    },
  ...
  We = function() {
    ...
    e.prototype.traceUIViewEvent = function(e, r, n) {
      void 0 === n && (n = ""),
      this.enabled(t.Category.UIVIEW) && console.log("ui-view: " + G(30, e) + " " + V(r) + n)
    },
    ...
    e.prototype.invokeHook = function() {
      ...
      if (!e._deregistered) {
        ...
        try {
          ...
          return ! this.type.synchronous && ae(u) ? u.
          catch(i).then(a, o) : a(u)
        } catch(t) {
  ...
  Ye = function() {
    ...
    e.prototype._getDefaultMatchCriteria = function() {
      return b(this.tranSvc._pluginapi._getPathTypes(),
      function() {
        return ! 0
      })
    },
    e.prototype._getMatchingNodes = function(e) {
      ...
      return Re(this.tranSvc._pluginapi._getPathTypes()).reduce(function(i, o) {
        ...
        u = e[o.name] || [],
        s = a ? u: [P(u)];
        return i[o.name] = r._matchingNodes(s, n[o.name]),
        i
      },
      {})
    },
  ...
  ir = function() {
    ...
    t.treeChanges = function(e, r, n) {
      function i(t, e) {
        var n = nr.clone(t);
        return n.paramValues = r[e].paramValues,
        n
      }
      for (var o = 0,
      a = Math.min(e.length, r.length); o < a && e[o].state !== n &&
      function(e, r) {
  ...
  ar = function() {
    function t(e, r, n, i, o) {
      if (this.resolved = !1, this.promise = void 0, e instanceof t) ve(this, e);
        ...
        this.promise = this.resolved ? se.$q.when(this.data) : void 0
    ...
    t.prototype.resolve = function(t, e) {
      ...
      l = function(t) {
        return r.data = t,
        r.resolved = !0,
        ze.traceResolvableResolved(r, e),
        r.data
      };
  ...
  pr = function() {
    ...
    t.prototype.subContext = function(e) {
      return new t(ir.subPath(this._path,
      function(t) {
        return t.state === e
      }))
    },
  ...
  hr = function() {
    function t(t) {
      this.context = t,
      this.native = this.get(lr) || se.$injector
    }
  ...
  vr = function() {
    function e(e, r, n) {
      var i = this;
      if (this._deferred = se.$q.defer(), this.promise = this._deferred.promise, this._registeredHooks = {},
      this._hookBuilder = new Ze(this), this.isActive = function() {
      ...
      this._treeChanges = ir.treeChanges(e, o, this._options.reloadState),
    ...
    e.prototype.params = function(t) {
      ...
      Object.freeze(this._treeChanges[t].map(At("paramValues")).reduce(Se, {}))
    },
    e.prototype.injector = function(t, e) {
      void 0 === e && (e = "to");
      var r = this._treeChanges[e];
      return t && (r = ir.subPath(r,
      function(e) {
    ...
    e.prototype.getResolveTokens = function(t) {
      return void 0 === t && (t = "to"),
      new pr(this._treeChanges[t]).getTokens()
    },
    e.prototype.addResolvable = function(t, e) {
      void 0 === e && (e = ""),
      t = Ut(ar)(t) ? t: new ar(t);
    ...
    e.prototype.views = function(t, e) {
      ...
      return r = e ? r.filter(Ht("state", e)) : r,
      r.map(At("views")).filter(f).reduce(Te, [])
    },
    ...
    e.prototype.redirect = function(t) {
      for (var e = 1,
      r = this; null != (r = r.redirectedFrom());) if (++e > 20) throw new Error("Too many consecutive Transition redirects (20+)");
      var n = {
        redirectedFrom: this,
        source: "redirect"
      };
    ...
    e.prototype.run = function() {
      ...
      u = function() {
        ...
        ze.traceTransitionStart(e),
        se.$q.when(void 0)
      },
      s = n(t.TransitionHookPhase.BEFORE);
      return Ke.invokeHooks(s, u).then(a).then(i, o),
      this.promise
    },
  ...
  yr = function(t) {
    ...
    return (mr = mr || s([[Dt(Qt), Mt("undefined")], [Kt, Mt("null")], [ae, Mt("[Promise]")], [e,
    function(t) {
      return t._transitionRejection.toString()
    }], [Ut(Ue), u("toString")], [Ut(vr), u("toString")], [Ut(ar), u("toString")], [c, z], [Mt(!0), f]]))(t)
  },
  gr = function(t) {
    return function(e) {
      if (!e) return ["", ""];
  ...
  wr = function() {
    function t() {
      this.enqueue = !0,
      this.typeQueue = [],
      this.defaultTypes = g(t.prototype, ["hash", "string", "query", "path", "int", "bool", "date", "json", "any"]);
      var e = function(t, e) {
        return new Xe(ve({
          name: e
        },
  ...
  Cr = function() {
    ...
    return t.prototype.builder = function(t, e) {
      var r = this.builders,
      n = r[t] || [];
      return te(t) && !Qt(e) ? n.length > 1 ? n: n[0] : te(t) && Zt(e) ? (r[t] = n, r[t].push(e),
      function() {
  ...
  Pr = function() {
    ...
    t.prototype.flush = function() {
      ...
      s = function(e) {
        ...
        if (l) {
          ...
          var v = u[f];
          if (u[f] = r.length, p >= 0 && v === r.length) return r.push(c),
          n;
          p < 0 && a.push(c),
          r.push(c)
        }
    ...
    t.prototype.attachRoute = function(t) { ! t.abstract && t.url && this.$urlRouter.rule(this.$urlRouter.urlRuleFactory.create(t))
    },
    t
  } (),
  kr = function() {
    function t(t) {
      ...
      this.states = {},
      this.listeners = [],
      this.matcher = new Tr(this.states),
      this.builder = new Cr(this.matcher, t.urlMatcherFactory),
      this.stateQueue = new Pr(this, t.urlRouter, this.states, this.builder, this.listeners),
      this._registerRoot()
    }
    ...
    t.prototype._deregisterTree = function(t) {
      ...
      return o.forEach(function(t) {
        ...
        r.rules().filter(Ht("state", t)).forEach(r.removeRule.bind(r)),
  ...
  jr = function() {
    ...
    e.prototype.parameters = function(t) {
      return void 0 === t && (t = {}),
      !1 === t.inherit ? this._params: Oe(this._cache.path.map(function(t) {
        return t._params
      }))
    },
    ...
    e.prototype.format = function(t) {
      ...
      s = o.map(function(t) {
        ...
        n = t.encoded,
        i = t.isDefaultValue;
        if (! (null == n || i && !1 !== r) && (re(n) || (n = [n]), 0 !== n.length)) return e.raw || (n = b(n, encodeURIComponent)),
        n.map(function(t) {
          return e.id + "=" + t
        })
    ...
    e.compare = function(t, r) {
      ...
      u = C(a(t), a(r));
      for (i = 0; i < u.length; i++) if (0 !== (n = u[i][0] - u[i][1])) return n;
      return 0
    },
    e.nameValidator = /^\w+([-.]+\w+)*(?:\[\])?$/,
    e
  ...
  Vr = function() {
    ...
    t.prototype.fromUrlMatcher = function(t, e) {
      ...
      var i = e;
      te(e) && (e = this.router.urlMatcherFactory.compile(e)),
      Ut(jr)(e) && (i = function(t) {
        return e.format(t)
      });
      var o = {
        urlMatcher: t,
  ...
  var qr = function() {
    function t(e) {
      ...
      this._sorted = !1,
      this._router = e,
      this.urlRuleFactory = new Vr(e),
      p(Mt(t.prototype), this, Mt(this))
    }
    return t.prototype.dispose = function() {
      this.listen(!1),
      this._rules = [],
    ...
    t.prototype.otherwise = function(t) {
      var e = at(t);
      this._otherwiseFn = this.urlRuleFactory.create(Mt(!0), e),
      this._sorted = !1
    },
    ...
    t.prototype.when = function(t, e, r) {
      ...
      return Qt(r && r.priority) && (n.priority = r.priority),
      this.rule(n),
      n
    },
  ...
  Dr = function() {
    ...
    t.prototype.deactivateViewConfig = function(t) {
      ze.traceViewServiceEvent("<- Removing", t),
      we(this._viewConfigs, t)
    },
    t.prototype.activateViewConfig = function(t) {
      ze.traceViewServiceEvent("-> Registering", t),
    ...
    t.prototype.sync = function() {
      ...
      function n(t) {
        for (var e = t.viewDecl.$context,
        r = 0; ++r && e.parent;) e = e.parent;
        return r
      }
      var i = this,
      ...
      u = function(e) {
        ...
        return r.length > 1 && r.sort(a(n, -1)),
        [e, r[0]]
      },
      s = function(t) {
        var e = t[0],
    ...
    t.prototype.registerUIView = function(t) {
      ...
      return e.filter(r).length && ze.traceViewServiceUIViewEvent("!!!! duplicate uiView named:", t),
      e.push(t),
      this.sync(),
      function() {
        if ( - 1 === e.indexOf(t)) return void ze.traceViewServiceUIViewEvent("Tried removing non-registered uiView", t);
        ze.traceViewServiceUIViewEvent("<- Deregistering", t),
        we(e)(t)
      }
    },
    ...
    t.normalizeUIViewTarget = function(t, e) {
      ...
      n = r[0] || "$default",
      i = te(r[1]) ? r[1] : "^",
      o = /^(\^(?:\.\^)*)\.(.*$)/.exec(n); (o && (i = o[1], n = o[2]), "!" === n.charAt(0) && (n = n.substr(1), i = ""), /^(\^(?:\.\^)*)$/.exec(i)) ? i = i.split(".").reduce(function(t, e) {
        return t.parent
      },
      t).name: "." === i && (i = t.name);
      return {
  ...
  Nr = function() {
    function t() {
      ...
      this.transitionHistory = new Ne([], 1),
      this.successfulTransitions = new Ne([], 1)
    }
    return t.prototype.dispose = function() {
  ...
  Wr = function() {
    ...
    t.prototype.deferIntercept = function(t) {},
    t.prototype.match = function(t) {},
    t.locationServiceStub = Fr(Ur),
    t.locationConfigStub = Fr(Lr),
    t
  } (),
  zr = 0,
  Jr = function() {
    function t(t, e) {
      void 0 === t && (t = Wr.locationServiceStub),
      void 0 === e && (e = Wr.locationConfigStub),
      ...
      this._disposables = [],
      this.trace = ze,
      this.viewService = new Dr,
      this.transitionService = new bn(this),
      this.globals = new Nr,
      this.urlMatcherFactory = new Ir,
      this.urlRouter = new qr(this),
      this.stateRegistry = new kr(this),
      this.stateService = new Rn(this),
      this.urlService = new Wr(this),
      this._plugins = {},
    ...
    t.prototype.plugin = function(t, e) {
      ...
      return this._disposables.push(r),
      this._plugins[r.name] = r
    },
  ...
  wn = function() {
    function t(t, e, r, n, i, o, a, u) {
      void 0 === i && (i = !1),
      void 0 === o && (o = Ke.HANDLE_RESULT),
      void 0 === a && (a = Ke.REJECT_ERROR),
      void 0 === u && (u = !1),
      this.name = t,
      this.hookPhase = e,
      this.hookOrder = r,
  ...
  bn = function() {
    function e(t) {
      ...
      this._pluginapi = p(Mt(this), {},
      Mt(this), ["_definePathType", "_defineEvent", "_getPathTypes", "_getEvents", "getHooks"]),
    ...
    e.prototype._registerCoreTransitionHooks = function() {
      ...
      t.addCoreResolves = Qr(this),
      t.ignored = _n(this),
      t.invalid = $n(this),
      t.redirectTo = Yr(this),
      t.onExit = Xr(this),
      t.onRetain = en(this),
      t.onEnter = nn(this),
      t.eagerResolve = an(this),
      t.lazyResolve = sn(this),
      t.loadViews = fn(this),
      t.activateViews = pn(this),
      t.updateGlobals = dn(this),
      t.updateUrl = mn(this),
      t.lazyLoad = gn(this)
    },
    e
  ...
  Rn = function() {
    ...
    e.prototype._handleInvalidTargetState = function(t, e) {
      ...
      f = function(t) {
        if (t instanceof Je) {
          var e = t;
          return e = n.target(e.identifier(), e.params(), e.options()),
          e.valid() ? a() !== u ? Ue.superseded().toPromise() : n.transitionTo(e.identifier(), e.params(), e.options()) : Ue.invalid(e.error()).toPromise()
        }
      };
      return r()
    },
      ...
      var c = function(e) {
        return function(r) {
          if (r instanceof Ue) {
            ...
            if (r.type === t.RejectType.IGNORED) return n && o.urlRouter.update(),
            se.$q.when(a.current);
            var u = r.detail;
            ...
            if (r.type === t.RejectType.ABORTED) return n && o.urlRouter.update(),
            se.$q.reject(r)
          }
          return i.defaultErrorHandler()(r),
          se.$q.reject(r)
        }
      },
    ...
    e.prototype.lazyLoad = function(t, e) {
      ...
      return e = e || this.router.transitionService.create(n, i),
      ct(e, r)
    },
    e
  } (),
  ...
  An = function(t, e) {
    var r = e[0],
    n = e[1];
    return t.hasOwnProperty(r) ? re(t[r]) ? t[r].push(n) : t[r] = [t[r], n] : t[r] = n,
    t
  },
  Hn = function(t) {
  ...
  Fn = function(t) {
    function e(e) {
      ...
      return window.addEventListener("hashchange", r._listener, !1),
      r
    }
    return Nn(e, t),
  ...
  Bn = function(t) {
    function e(e) {
      ...
      return r._config = e.urlService.config,
      window.addEventListener("popstate", r._listener, !1),
      r
    }
    return Mn(e, t),
    e.prototype._get = function() {
  ...
  ti = function() {
    ...
    return t.prototype.load = function() {
      ...
      return e.all(i).then(function(e) {
        return ze.traceViewServiceEvent("Loaded", t),
  ...
  ei = function() {
    function t() {
      var t = this;
      this._useHttp = Vt.version.minor < 3,
      this.$get = ["$http", "$templateCache", "$injector",
      function(e, r, n) {
        return t.$templateRequest = n.has && n.has("$templateRequest") && n.get("$templateRequest"),
        t.$http = e,
        t.$templateCache = r,
        t
      }]
  ...
  ai = function() {
    ...
    t.monkeyPatchPathParameterType = function(t) {
      ...
      e.encode = function(t) {
        return null != t ? t.toString().replace(/(~|\/)/g,
        function(t) {
          return {
            "~": "~~",
            "/": "~2F"
      ...
      e.decode = function(t) {
        return null != t ? t.toString().replace(/(~~|~2F)/g,
        function(t) {
          return {
            "~~": "~",
            "~2F": "/"
  ...
  ui = function() {
    ...
    t.prototype.when = function(e, r) {
      return (re(r) || Zt(r)) && (r = t.injectableHandler(this._router, r)),
  ...
  _t.$inject = ["$rootScope"],
  si.provider("$uiRouter", gt),
  fi.provider("$urlRouter", ["$uiRouterProvider", vi]),
  ci.provider("$urlService", di("urlService")),
  ci.provider("$urlMatcherFactory", ["$uiRouterProvider",
  function() {
    return hi.urlMatcherFactory
  }]),
  ci.provider("$templateFactory",
  function() {
    return new ei
  }),
  li.provider("$stateRegistry", di("stateRegistry")),
  li.provider("$uiRouterGlobals", di("globals")),
  li.provider("$transitions", di("transitionService")),
  li.provider("$state", ["$uiRouterProvider", mi]),
  li.factory("$stateParams", ["$uiRouter",
  function(t) {
    ...
    return {
      ...
      link: function(n, i, o, a) {
        function u() {
          var t = h();
          l && l(),
          f && (l = f.$$addStateInfo(t.uiState, t.uiStateParams)),
        ...
        d = $t(o.uiSref);
        p.uiState = d.state,
        p.uiStateOpts = o.uiSrefOpts ? n.$eval(o.uiSrefOpts) : {},
        d.paramExpr && (n.$watch(d.paramExpr,
        function(t) {
          p.uiStateParams = ve({},
          t),
          u()
        },
        !0), p.uiStateParams = ve({},
        n.$eval(d.paramExpr))),
        u(),
        n.$on("$destroy", t.stateRegistry.onStatesChanged(u)),
        n.$on("$destroy", t.transitionService.onSuccess({},
        u)),
        c.clickable && (s = Et(i, r, e, c, h), Tt(i, n, s, p.uiStateOpts))
      }
    }
  }];
  var wi;
    ...
    return {
      ...
      link: function(n, i, o, a) {
        function u() {
          var t = d();
          p && p(),
          f && (p = f.$$addStateInfo(t.uiState, t.uiStateParams)),
          null != t.href && o.$set(c.attr, t.href)
        }
        var s, c = Rt(i),
        f = a[1] || a[0],
        ...
        n.$on("$destroy", t.transitionService.onSuccess({},
        u)),
        c.clickable && (s = Et(i, r, e, c, d), Tt(i, n, s, h.uiStateOpts))
      }
    }
  }];
  var _i;
  _i = ["$state", "$stateParams", "$interpolate", "$uiRouter",
  function(t, e, r, n) {
    return {
      restrict: "A",
      ...
      function(e, i, o) {
        ...
        e.$on("$stateChangeSuccess", s),
        e.$on("$destroy", n.transitionService.onStart({},
        a)),
        n.globals.transition && a(n.globals.transition),
        s()
      }]
    }
  }],
  Vt.module("ui.router.state").directive("uiSref", yi).directive("uiSrefActive", _i).directive("uiSrefActiveEq", _i).directive("uiState", wi),
  Pt.$inject = ["$state"],
  kt.$inject = ["$state"],
  Vt.module("ui.router.state").filter("isState", Pt).filter("includedByState", kt);
  var $i;
  $i = ["$view", "$animate", "$uiViewScroll", "$interpolate", "$q",
  function(t, e, r, n, i) {
    function o(t, r) {
      return {
    ...
    s = {
      ...
      compile: function(e, c, f) {
        return function(e, c, l) {
          function p(t) { (!t || t instanceof ti) && (a(S, t) || (ze.traceUIViewConfigUpdated(E, t && t.viewDecl && t.viewDecl.$context), S = t, d(t)))
          }
          function h() {
            if (v && (ze.traceUIViewEvent("Removing (previous) el", v.data("$uiView")), v.remove(), v = null), y && (ze.traceUIViewEvent("Destroying scope", E), y.$destroy(), y = null), m) {
              ...
              ze.traceUIViewEvent("Animate out", t),
              $.leave(m,
              function() {
                t.$$animLeave.resolve(),
                v = null
          ...
          function d(t) {
            ...
            function(t) {
              ...
              function() {
                o.resolve(),
                y && y.$emit("$viewContentAnimationEnded"),
                (Qt(_) && !_ || e.$eval(_)) && r(t)
              }),
              h()
            });
          ...
          ze.traceUIViewEvent("Linking", E),
          c.data("$uiView", {
            $uiView: E
          }),
          d(),
          g = t.registerUIView(E),
          e.$on("$destroy",
          function() {
            ze.traceUIViewEvent("Destroying/Unregistering", E),
            g()
          })
        }
      }
  ...
  bi = 0;
  Vt.module("ui.router.state").directive("uiView", $i),
  Vt.module("ui.router.state").directive("uiView", Ot),
  Vt.module("ui.router.state").provider("$uiViewScroll", jt);
  t.
default = "ui.router",
  t.core = Yn,
  t.watchDigests = _t,
  t.getLocals = gi,
  t.getNg1ViewConfigFactory = vt,
  t.ng1ViewsBuilder = mt,
  t.Ng1ViewConfig = ti,
  t.StateProvider = ii,
  t.UrlRouterProvider = ui,
  t.fromJson = le,
  t.toJson = pe,
  t.copy = he,
  t.forEach = de,
  ...
  t.sortBy = Ae,
  t.composeSort = He,
  t.silenceUncaughtInPromise = qe,
  t.silentRejection = De,
  t.notImplemented = ue,
  t.services = se,
  t.Glob = Bt,
  t.curry = r,
  ...
  t.padString = G,
  t.kebobString = W,
  t.functionToString = z,
  t.fnToString = J,
  t.stringify = Q,
  t.beforeAfterSubstr = gr,
  t.splitOnDelim = K,
  t.joinNeighborsR = Y,
  t.Trace = We,
  t.trace = ze,
  ...
  t.PathNode = nr,
  t.PathUtils = ir,
  t.resolvePolicies = ur,
  t.defaultResolvePolicy = or,
  t.Resolvable = ar,
  t.NATIVE_INJECTOR_TOKEN = lr,
  t.ResolveContext = pr,
  t.resolvablesBuilder = nt,
  t.StateBuilder = Cr,
  t.StateObject = Gt,
  t.StateMatcher = Tr,
  t.StateQueueManager = Pr,
  t.StateRegistry = kr,
  t.StateService = Rn,
  t.TargetState = Je,
  t.HookBuilder = Ze,
  ...
  t.Transition = vr,
  t.TransitionHook = Ke,
  t.TransitionEventType = wn,
  t.defaultTransOpts = Sn,
  t.TransitionService = bn,
  t.UrlMatcher = jr,
  ...
  t.UrlService = Wr,
  t.ViewService = Dr,
  t.UIRouterGlobals = Nr,
  t.UIRouter = Jr,
  t.$q = En,
  t.$injector = kn,
  t.BaseLocationServices = Dn,
  t.HashLocationService = Fn,
  t.MemoryLocationService = Ln,
  t.PushStateLocationService = Bn,
  t.MemoryLocationConfig = Gn,
  t.BrowserLocationConfig = Wn,
  t.splitHash = xn,
  t.splitQuery = jn,
  t.splitEqual = In,
  t.trimHashVal = Vn,
  t.keyValsToObjectR = An,
  t.getParams = Hn,
  t.parseUrl = pt,
  t.buildUrl = qn,
  t.locationPluginFactory = ht,
  t.servicesPlugin = dt,
  t.hashLocationPlugin = zn,
  t.pushStateLocationPlugin = Jn,
  t.memoryLocationPlugin = Qn,
  t.UIRouterPluginBase = Kn,
